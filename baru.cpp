...
int main(){
	TreeSerat rootSerat=nullptr;
 	pointerSerat newNodeS;
	TreeBMI rootBMI=nullptr;
	pointerBMI newNodeB,checkBMI;
	TreeKalori rootKalori=nullptr;
	pointerKalori newNodeK,checkKalori;
  ...
  createNodeBMI(newNodeB,"kekurangan BB","46.0",9); insertBSTBMI(rootBMI,newNodeB);
 ...
 createNodeBMI(newNodeB,"normal","220.0/5.0",11); insertBSTBMI(rootBMI,newNodeB);
  ...
  createNodeBMI(newNodeB,"kelebihan BB","5.0",15); insertBSTBMI(rootBMI,newNodeB);
  ...
  createNodeBMI(newNodeB,"kelebihan BB","3.0",19); insertBSTBMI(rootBMI,newNodeB);
...
if(checkKalori=rootKalori->right->right){
 ...
 std::cout<<"status:"<<checkKalori->status<<std::endl;
